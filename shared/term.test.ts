...
// describe.skip('Calculate study year', () => {
...
describe('Format term', () => {
  test('short in English', () => {
    const formattedTerm = formatShortTerm(testStringSpringTerm, 'Spring', true)
    expect(formattedTerm).toMatch('Spring 19')
  })
  test('short in Swedish', () => {
    const formattedTerm = formatShortTerm(testStringSpringTerm, 'VT', false)
