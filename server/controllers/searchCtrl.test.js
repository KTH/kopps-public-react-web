...
describe('Controller searchCtrl, function performCourseSearch', () => {
  test('search by pattern in english', async done => {
  ...
  test('search by pattern in swedish', async done => {
    getSearchResults.mockReturnValue(Promise.resolve(TEST_API_ANSWER_ALGEBRA))
  ...
  test('search by one educational level param in english', async done => {
    getSearchResults.mockReturnValue(Promise.resolve(TEST_API_ANSWER_ALGEBRA))
  ...
  test('search by all educational level param in english', async done => {
    getSearchResults.mockReturnValue(Promise.resolve(TEST_API_ANSWER_ALGEBRA))
  ...
  // showOptions
  test('search cancelled courses in english', async done => {
    getSearchResults.mockReturnValue(Promise.resolve(TEST_API_ANSWER_ALGEBRA))
  ...
  test('search by all extra options flag level param in english', async done => {
    getSearchResults.mockReturnValue(Promise.resolve(TEST_API_ANSWER_ALGEBRA))
  ...
  // period
  test('search by third spring period (Spring 2021 period 3) in english', async done => {
    getSearchResults.mockReturnValue(Promise.resolve(TEST_API_ANSWER_ALGEBRA))
  ...
  test('search by fourth spring period (Spring 2021 period 4) in english', async done => {
    getSearchResults.mockReturnValue(Promise.resolve(TEST_API_ANSWER_ALGEBRA))
  ...
  test('search by summer period 2021 sommar when both spring and autumn periods are presented in a list in english', async done => {
    getSearchResults.mockReturnValue(Promise.resolve(TEST_API_ANSWER_ALGEBRA))
  ...
  test('search by first autumn period (Autumn 2021 period 1) in english', async done => {
    getSearchResults.mockReturnValue(Promise.resolve(TEST_API_ANSWER_ALGEBRA))
  ...
  test('search by second autumn period (Autumn 2021 period 2) in english', async done => {
    getSearchResults.mockReturnValue(Promise.resolve(TEST_API_ANSWER_ALGEBRA))
  ...
  test('search by several periods in english', async done => {
    getSearchResults.mockReturnValue(Promise.resolve(TEST_API_ANSWER_ALGEBRA))
  ...
  // department
  test('search by school/department ABD in english', async done => {
    getSearchResults.mockReturnValue(Promise.resolve(TEST_API_ANSWER_ALGEBRA))
