...
import { createPeriodTexts } from '../searchHelper'
import { SemesterNumber } from 'kopps-public-react-web/shared/semesterUtils'
  ...
  describe('createPeriodTexts', () => {
    ...
    describe('in English', () => {
      it.each(['P0', 'P1', 'P2'])(
        ...
        (period: KTHPeriodLabel) => {
          expect(
            createPeriodTexts(LanguageCode.English, {
              start: {
                period,
                semester: new AcademicSemester(2025, SemesterNumber.Autumn),
              },
