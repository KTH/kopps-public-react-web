...
describe('Render component StudyHandbook and check its menu, content and links', () => {
  test('check all links on the page in English', () => {
    ...
    expect(links[3]).toHaveTextContent('Search courses')
    ...
    expect(links[6]).toHaveTextContent('Study Handbook 00/01 to 07/08') // content link
    expect(links[6].href).toStrictEqual('https://intra.kth.se/utbildning/systemstod/kopps/shb')
  ...
  test('check all links on the page in Swedish', () => {
    ...
    expect(links[6]).toHaveTextContent('Studiehandboken 00/01 tom 07/08') // content link
    expect(links[6].href).toStrictEqual('https://intra.kth.se/utbildning/systemstod/kopps/shb')
