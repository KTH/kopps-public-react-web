...
function LiteratureList() {
  ...
  const { heading, subHeading, intro, missing } = i18n.messages[languageIndex].literatureList
  ...
  return (
    <>
      <Row>
        <Col>
          <PageHeading subHeading={subHeading(selectedSchool.name, formatLongTerm(selectedTerm, language))}>
            {heading}
          </PageHeading>
        </Col>
      </Row>
