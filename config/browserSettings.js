...
const markHtmlFromKopps = Boolean(getEnv('MARK_HTML_FROM_KOPPS', devDefaults(true))) // TODO: needs to be removed after we are done with all kopps to ladok replacements
